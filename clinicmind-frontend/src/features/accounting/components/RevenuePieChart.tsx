...
import { useRevenueByCategory } from "../hooks/useRevenue"
...
export function RevenuePieChart({ filters }: RevenuePieChartProps) {
  const { data: categories = [], isLoading } = useRevenueByCategory(filters)
  ...
  return (
    <Card>
      <CardHeader>
        <h2 className="text-lg font-semibold">Recettes par catégorie</h2>
      </CardHeader>
